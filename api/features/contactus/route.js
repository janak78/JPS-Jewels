...
<head>
  ...
  <style>
    ...
    .email-header { background: #c9a236; color: #fff; font-size: 24px; text-align: center; padding: 20px; border-bottom: 3px solid #000; }
    .email-body { padding: 20px; }
    .email-body h2 { color: #c9a236; margin: 0 0 10px; }
